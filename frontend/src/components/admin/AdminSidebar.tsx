...
const AdminSidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/admin/courses', label: 'Courses', icon: <BookOpen className="h-5 w-5" /> },
    { path: '/admin/tutoring', label: 'Tutoring', icon: <School className="h-5 w-5" /> },
    { path: '/admin/achievements', label: 'Achievements', icon: <Award className="h-5 w-5" /> },
    { path: '/admin/reviews', label: 'Reviews', icon: <Star className="h-5 w-5" /> },
    { path: '/admin/points', label: 'Points & Rewards', icon: <Coins className="h-5 w-5" /> },
    { path: '/admin/subscriptions', label: 'Subscriptions', icon: <Package className="h-5 w-5" /> },
    { path: '/admin/blog', label: 'Blog Posts', icon: <FileText className="h-5 w-5" /> },
    { path: '/admin/announcements', label: 'Announcements', icon: <Bell className="h-5 w-5" /> },
