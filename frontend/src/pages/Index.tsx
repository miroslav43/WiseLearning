...
const HomePage: React.FC = () => {
  const featuredCourses = mockCourses.filter(course => course.featured).slice(0, 6);
    ...
    <div className="flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2 space-y-6" data-aos="fade-right">
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                Învață și Excelează la <span className="text-brand-800">Bacalaureat</span>
              </h1>
              <p className="text-lg text-gray-700">
                Cea mai completă platformă educațională cu cursuri video, teste și exerciții personalizate pentru nota maximă la examen.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-2">
                <Link to="/courses">
                  <Button size="lg" className="w-full sm:w-auto bg-brand-800 hover:bg-brand-700 text-white shadow-lg hover:shadow-xl transition-all">
                    Explorează cursuri
                  </Button>
                </Link>
                <Link to="/register">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto border-brand-800 text-brand-800 hover:bg-brand-50">
            ...
            <div className="lg:w-1/2" data-aos="fade-left" data-aos-delay="200">
              <div className="relative rounded-lg overflow-hidden shadow-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-brand-800/80 to-transparent p-6">
                  <p className="text-white font-medium">Peste 15,000 de elevi ne-au ales deja</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container max-w-6xl mx-auto px-4">
          ...
          >
            <div>
              <h2 className="text-3xl font-bold text-gray-900">Cursuri populare</h2>
              <p className="text-gray-600 mt-2 max-w-2xl">Cele mai apreciate cursuri pentru pregătirea examenului de Bacalaureat</p>
            </div>
            <Link to="/courses" className="mt-4 md:mt-0 flex items-center text-brand-800 hover:text-brand-700 font-medium">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="relative" data-aos="fade-right" data-aos-delay="0">
              <div className="bg-brand-50 p-8 rounded-xl flex flex-col items-center text-center h-full">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Alege cursurile</h3>
                <p className="text-gray-600">
                  Explorează catalogul nostru și alege cursurile care se potrivesc nevoilor tale de învățare pentru Bacalaureat.
                </p>
              </div>
            ...
            <div className="relative" data-aos="fade-up" data-aos-delay="200">
              <div className="bg-brand-50 p-8 rounded-xl flex flex-col items-center text-center h-full">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Învață în ritmul tău</h3>
                <p className="text-gray-600">
                  Urmărește videoclipurile, rezolvă teste și exersează cu materialele interactive disponibile oricând.
                </p>
              </div>
              <div className="hidden md:block absolute top-1/2 -right-4 transform -translate-y-1/2">
                <ArrowRight className="h-8 w-8 text-brand-300" />
            ...
            <div data-aos="fade-left" data-aos-delay="400">
              <div className="bg-brand-50 p-8 rounded-xl flex flex-col items-center text-center h-full">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-4">Obține rezultate</h3>
                <p className="text-gray-600">
                  Monitorizează-ți progresul, primește feedback personalizat și pregătește-te pentru succes la Bacalaureat.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-3xl font-bold text-gray-900">Ce spun elevii despre noi</h2>
            <p className="text-gray-600 mt-2 max-w-2xl mx-auto">
              Experiențele reale ale elevilor care au obținut note mari la Bacalaureat cu ajutorul nostru
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="md:w-1/2 space-y-6" data-aos="fade-left" data-aos-delay="200">
              <h2 className="text-3xl font-bold text-gray-900">Despre Companie</h2>
              <p className="text-gray-700">
                WiseLearning SRL este o companie educațională din România dedicată îmbunătățirii experienței de învățare pentru elevii care se pregătesc pentru examenele de Bacalaureat.
              </p>
              <p className="text-gray-700">
                Cu o echipă de profesori experimentați și pasionați, ne concentrăm pe crearea de materiale educaționale de calitate, interactive și personalizate pentru nevoile fiecărui elev.
              </p>
              <div className="pt-4">
                <Link to="/about">
                  <Button variant="outline" className="border-brand-800 text-brand-800 hover:bg-brand-50">
      ...
      <section className="py-20 bg-gradient-to-r from-brand-800 to-brand-900 text-white">
        <div className="container max-w-6xl mx-auto px-4 text-center" data-aos="fade-up">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">Începe călătoria spre succes la Bacalaureat</h2>
          <p className="text-lg md:text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Alătură-te miilor de elevi care își transformă visele în realitate cu ajutorul platformei noastre educaționale premium.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/register">
              <Button size="lg" className="bg-white text-brand-800 hover:bg-gray-100 w-full sm:w-auto font-medium">
